      ...
      },
      {
        ...
        rules: [
          ...
          },
          {
            ...
            expr: |||
              sum by(name, namespace, %(clusterLabel)s)(increase(%(kubeApiserverMetricPrefix)saggregator_unavailable_apiservice_total[10m])) > 4
            ||| % $._config,
            labels: {
              severity: 'warning',
            },
          ...
          },
          {
            ...
            expr: |||
              (1 - max by(name, namespace, %(clusterLabel)s)(avg_over_time(%(kubeApiserverMetricPrefix)saggregator_unavailable_apiservice[10m]))) * 100 < 85
            ||| % $._config,
            'for': '5m',
            labels: {
              severity: 'warning',
